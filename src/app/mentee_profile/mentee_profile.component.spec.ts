...
import { mentee_profileComponent } from './mentee_profile.component';


describe('mentee_profileComponent', () => {
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(mentee_profileComponent);
